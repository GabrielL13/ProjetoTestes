...
class Paciente(Usuario):
    ...
    def __init__(self,nome="Teste", senha="", cpf="admin", telefone="", rg="", cartaoSus="",endereco="",data_de_nascimento="",estado_civil="", tipo_sanguineo="", nacionalidade="", sexo="", info_adicionais=""):
